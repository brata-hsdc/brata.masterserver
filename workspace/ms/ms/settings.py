...
#     'django.middleware.csrf.CsrfViewMiddleware',  # turned off to make it easier to develop REST API
...
STATIC_ROOT = '/opt/designchallenge2016/brata.masterserver/workspace/ms/static/'
STATIC_URL = '/static/'

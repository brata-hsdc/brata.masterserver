...
urlpatterns = [
    ...
    url(r'^navtest_team/(?P<pass_code>[^/]+)/(?P<lat1>[0-9.-]+)/(?P<lon1>[0-9.-]+)/(?P<lat2>[0-9.-]+)/(?P<lon2>[0-9.-]+)/(?P<lat3>[0-9.-]+)/(?P<lon3>[0-9.-]+)/(?P<lat4>[0-9.-]+)/(?P<lon4>[0-9.-]+)/$', views.NavTestTeam.as_view(), name="navtest_team"),

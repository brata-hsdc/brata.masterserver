...
class Team(models.Model):
    ...
    registered       = models.ForeignKey("piservice.PiEvent", null=True, related_name="teams", default="", on_delete=models.SET_NULL)  # give name as string to avoid cyclic import dependency
